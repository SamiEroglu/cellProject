				...
				<div className="plantcelldiff-cont" style={{ width: "50%" }}>
					...
					<div className="order-cont">
						...
						<div className="plantcell-diff">
                            ...
                            <p>TEK HÜCRELİ CANLILARDA ÜREMEYİ, ÇOK HÜCRELİ CANLILARDA İSE YARALARIN ONARILMASI VE BÜYÜME GİBİ OLAYLARI SAĞLAR.</p>
				...
				<div className="animalcelldiff-cont" style={{ width: "50%" }}>
					...
					<div className="order-cont">
						...
						<div className="animalcell-diff">
                            ...
                            <p>OLUŞAN HÜCRELERİN GENETİK YAPISI ANA HÜCRELERİNDEN VE BİRBİRİNDEN FARKLIDIR.</p>
                            <p>EŞEYLİ ÜREYEN CANLILARDA EŞEY(ÜREME) HÜCRELERİNİN OLUŞUMUNU SAĞLAR.</p>
